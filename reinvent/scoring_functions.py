...
from custom import custom_score, tartarus_score
...
class Worker():
    ...
    def __init__(self, scoring_function=None):
        ...
        self.proc = pexpect.spawn('./reinvent/multiprocess.py ' + scoring_function,
                                  encoding='utf-8')
    ...
    def __call__(self, smiles):
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            for i in range(count):
                future = executor.submit(self.scoring_function, smiles[i])
...
def get_scoring_function(scoring_function, num_processes=None, **kwargs):
    ...
    scoring_function_classes = [no_sulphur, tanimoto, activity_model, custom_score, tartarus_score]
    ...
    return Multiprocessing(scoring_function=scoring_function_class)
